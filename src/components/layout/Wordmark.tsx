...
const sizes = {
  sm: {
    primary: 'text-[0.75rem] sm:text-[0.8125rem]',
    secondary: 'text-[0.5625rem] tracking-[0.24em] sm:text-[0.625rem] sm:tracking-[0.34em]',
    gap: 'gap-[0.15rem]',
  },
  md: {
    primary: 'text-[0.8125rem] sm:text-[0.9375rem]',
    secondary: 'text-[0.5625rem] tracking-[0.22em] sm:text-[0.6875rem] sm:tracking-[0.34em]',
    gap: 'gap-[0.2rem]',
  },
  lg: {
    primary: 'text-[1rem] sm:text-[1.25rem]',
    secondary: 'text-[0.6875rem] tracking-[0.22em] sm:text-[0.8125rem] sm:tracking-[0.34em]',
    gap: 'gap-[0.3rem]',
  },
} as const;
